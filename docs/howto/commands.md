...
| Reasoning effort | `{"action": "reasoning_effort", "level": "xhigh"}` | Change reasoning depth via /effort slash command. Levels: low, medium, high, xhigh. Turn-limited (default 5), auto-reverts to configured default. |
